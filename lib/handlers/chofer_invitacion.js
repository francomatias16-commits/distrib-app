...
// — ver lib/permisos-service.js (recurso `chofer_invitacion`).
export const ROLES_GESTION = rolesDe('chofer_invitacion', 'gestionar');
...
export default async function handler(req, res) {
  ...
  if (!perfil || !puede(perfil, 'gestionar', 'chofer_invitacion')) {
