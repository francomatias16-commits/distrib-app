...
const TIPOS_PREF_VALIDOS = [
  ...
  'score_caida_critica',
  'auditoria_anomalia',
  // 548/549: gatean pushes de push-interno (trigger SQL, migraciones
  // 016/437/547), no tipos del motor notifAuto — se agregan acá igual
  // porque este endpoint (push-prefs) es el único que lee/escribe
  // notif_prefs_auto desde el frontend, sin distinguir el canal.
  'stock_critico_bajo',
  'pedido_nuevo_recibido',
  'whatsapp_conversacion_estancada',
];
