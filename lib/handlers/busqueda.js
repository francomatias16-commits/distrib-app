...
export default async function handler(req, res) {
  ...
  // v1089: la copia local de esta función se reemplaza por el helper
  // compartido lib/postgrest-filtros.js — había tres copias sueltas y los
  // buscadores que no tenían ninguna (el del POS, ver punto 3 del audit)
  // quedaban rotos con nombres que traen coma o paréntesis.
