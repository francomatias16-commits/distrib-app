...
async function registrarUso({ usuarioId, empresaId, pregunta, proveedor, articulosEncontrados, latenciaMs, conversacionId, toolsUsadas }) {
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const [articulos, propuestaVigente] = await Promise.all([
      buscarArticulosRelevantes({ pregunta, rol: perfil.rol }),
