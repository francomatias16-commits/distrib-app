...
// el mismo nombre/valor para lib/asistente-tools.js (roles: ROLES_MIGRACION
// en las tools de historial/estado de migración), ahora vía rolesDe() en
// vez de array suelto — ver lib/permisos-service.js.
const ROLES_MIGRACION = rolesDe('migracion', 'acceder');
