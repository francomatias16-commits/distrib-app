...
// alrededor de esa única llamada (esa función vivía en lib/handlers/admin.js
// como `getUserConTimeout`; migrada el 2026-08-29 a `getUserSeguro`, ver
// lib/auth-helpers.js — mismo criterio, ahora compartido por todos los
// handlers).
//
