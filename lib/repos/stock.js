...
export async function buscarStockPaginado({
  ...
  let q = db
    ...
    // Alfabético por decisión explícita (no updated_at): es la pantalla de
    // stock más usada para buscar un producto puntual a simple vista, y con
    // ediciones constantes (ajustes, transferencias) un orden por
    // updated_at la volvería impredecible para ese uso. Decidido en la
    // sesión de la regla "ítem modificado sube al tope" — no reabrir sin
    // consultar de nuevo.
