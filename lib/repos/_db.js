...
function getClient() {
  ...
  _client = createClient(
    ...
    process.env.SUPABASE_SERVICE_ROLE_KEY,
    {
      ...
      // FIX v862: fetch con timeout (10s) — ver lib/supabase-fetch-timeout.js.
      // Sin esto, un .from()/.rpc() colgado se come los 60s del límite de
      // Vercel en vez de devolver un error controlado.
      global: { fetch: crearFetchConTimeout() },
    }
  );
  return _client;
}
