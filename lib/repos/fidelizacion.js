...
/**
 * Estado del programa de fidelización de la empresa. Si la empresa nunca
 * configuró uno, o lo desactivó desde /admin/fidelizacion.html, no existe
 * fila o `activo` es false — en ambos casos el portal cliente no debe
 * mostrar puntos ni recompensas (evita confundir a clientes de empresas
 * que no adoptaron el programa).
 */
export async function obtenerEstadoProgramaFidelizacion(empresa_id) {
  return db
