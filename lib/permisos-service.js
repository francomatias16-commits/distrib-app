...
const REGLAS = {
  ...
  // Migración 610 — sincronización del catálogo de productos con el
  // catálogo de WhatsApp/Commerce Manager de cada empresa. Mismo criterio
  // de roles que whatsapp_onboarding (conectar credenciales de Meta es
  // decisión de dueño/admin, no operativa del día a día).
  whatsapp_catalog: {
    conectar: ['dueno', 'admin'],
  },
  notif_estado_cuenta: {
