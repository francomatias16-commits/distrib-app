 ...
 * (whatsappEmbeddedSignupHandler) — un único gate ('conectar'), más
 * restrictivo que `whatsapp_panel` (no incluye vendedor): conectar el
 * WhatsApp Business propio de la empresa es una acción de alta/config,
 * no de uso diario del panel de conversaciones.
 *
