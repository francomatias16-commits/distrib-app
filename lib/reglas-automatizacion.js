...
async function ejecutarAccionWhatsapp(accion, payload, evento) {
  ...
  // FIX AUTOMATIZACION-003 (hallazgo original de esta pasada — ver
  // comentario completo en lib/handlers/notif.js): sin Authorization,
  // el guard de v960 devolvía 401 en silencio y la acción 'enviar_whatsapp'
  // de una regla personalizada nunca llegaba a mandar nada.
