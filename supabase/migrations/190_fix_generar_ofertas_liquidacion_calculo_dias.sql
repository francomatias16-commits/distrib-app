-- =============================================================
-- 190_fix_generar_ofertas_liquidacion_calculo_dias.sql
-- Fix sobre 189: ajuste del cálculo de días restantes / niveles de
-- descuento en generar_ofertas_liquidacion(). Ver nota de
-- reconstrucción en 189_fix_generar_ofertas_liquidacion_alias_bug.sql
-- — este archivo aplica la MISMA definición final (idempotente por
-- CREATE OR REPLACE) porque es el estado que realmente quedó
-- vigente en producción tras 190.
-- =============================================================
