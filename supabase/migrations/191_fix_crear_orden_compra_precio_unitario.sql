-- =============================================================
-- 191_fix_crear_orden_compra_precio_unitario.sql
-- Bug real: ordenes_compra_items.precio_unitario nunca se
-- completaba al crear una OC. Efecto silencioso: rompía la
-- detección de discrepancias de precio contra la factura de
-- proveedor más adelante en el flujo de compras (Fase 13).
-- 192 corrige además la ambigüedad de variable v_item sobre esta
-- misma función. Ver nota de reconstrucción en 189.
-- =============================================================
